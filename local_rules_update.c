...
//#pragma HLS PIPELINE
	...
	for(int i=0;i<6;i++){
		...
		if(unit21_0[i][4]==0){
			L[21][0] = L[21][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit21_1[i][4]==0){
			L[21][1] = L[21][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit22_0[i][4]==0){
			L[22][0] = L[22][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit22_1[i][4]==0){
			L[22][1] = L[22][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<5;i++){
		...
		if(unit23_0[i][4]==0){
			L[23][0] = L[23][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit23_1[i][4]==0){
			L[23][1] = L[23][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit24_0[i][4]==0){
			L[24][0] = L[24][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit24_1[i][4]==0){
			L[24][1] = L[24][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit25_0[i][4]==0){
			L[25][0] = L[25][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit25_1[i][4]==0){
			L[25][1] = L[25][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit26_0[i][4]==0){
			L[26][0] = L[26][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit26_1[i][4]==0){
			L[26][1] = L[26][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit27_0[i][4]==0){
			L[27][0] = L[27][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit27_1[i][4]==0){
			L[27][1] = L[27][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit28_0[i][4]==0){
			L[28][0] = L[28][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit28_1[i][4]==0){
			L[28][1] = L[28][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit29_0[i][4]==0){
			L[29][0] = L[29][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit29_1[i][4]==0){
			L[29][1] = L[29][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit30_0[i][4]==0){
			L[30][0] = L[30][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit30_1[i][4]==0){
			L[30][1] = L[30][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit31_0[i][4]==0){
			L[31][0] = L[31][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit31_1[i][4]==0){
			L[31][1] = L[31][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit32_0[i][4]==0){
			L[32][0] = L[32][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit32_1[i][4]==0){
			L[32][1] = L[32][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit33_0[i][4]==0){
			L[33][0] = L[33][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit33_1[i][4]==0){
			L[33][1] = L[33][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit34_0[i][4]==0){
			L[34][0] = L[34][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit34_1[i][4]==0){
			L[34][1] = L[34][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit35_0[i][4]==0){
			L[35][0] = L[35][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit35_1[i][4]==0){
			L[35][1] = L[35][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit36_0[i][4]==0){
			L[36][0] = L[36][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit36_1[i][4]==0){
			L[36][1] = L[36][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit37_0[i][4]==0){
			L[37][0] = L[37][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit37_1[i][4]==0){
			L[37][1] = L[37][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<5;i++){
		...
		if(unit38_0[i][4]==0){
			L[38][0] = L[38][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit38_1[i][4]==0){
			L[38][1] = L[38][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<8;i++){
		...
		if(unit39_0[i][4]==0){
			L[39][0] = L[39][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit39_1[i][4]==0){
			L[39][1] = L[39][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit40_0[i][4]==0){
			L[40][0] = L[40][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<13;i++){
		...
		if(unit40_1[i][4]==0){
			L[40][1] = L[40][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit41_0[i][4]==0){
			L[41][0] = L[41][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<17;i++){
		...
		if(unit41_1[i][4]==0){
			L[41][1] = L[41][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<10;i++){
		...
		if(unit42_0[i][4]==0){
			L[42][0] = L[42][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit42_1[i][4]==0){
			L[42][1] = L[42][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit43_0[i][4]==0){
			L[43][0] = L[43][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit43_1[i][4]==0){
			L[43][1] = L[43][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit44_0[i][4]==0){
			L[44][0] = L[44][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit44_1[i][4]==0){
			L[44][1] = L[44][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<3;i++){
		...
		if(unit45_0[i][4]==0){
			L[45][0] = L[45][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<18;i++){
		...
		if(unit45_1[i][4]==0){
			L[45][1] = L[45][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<8;i++){
		...
		if(unit46_0[i][4]==0){
			L[46][0] = L[46][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<17;i++){
		...
		if(unit46_1[i][4]==0){
			L[46][1] = L[46][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<10;i++){
		...
		if(unit47_0[i][4]==0){
			L[47][0] = L[47][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<13;i++){
		...
		if(unit47_1[i][4]==0){
			L[47][1] = L[47][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit48_0[i][4]==0){
			L[48][0] = L[48][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit48_1[i][4]==0){
			L[48][1] = L[48][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit49_0[i][4]==0){
			L[49][0] = L[49][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit49_1[i][4]==0){
			L[49][1] = L[49][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<3;i++){
		...
		if(unit50_0[i][4]==0){
			L[50][0] = L[50][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<16;i++){
		...
		if(unit50_1[i][4]==0){
			L[50][1] = L[50][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit51_0[i][4]==0){
			L[51][0] = L[51][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit51_1[i][4]==0){
			L[51][1] = L[51][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit52_0[i][4]==0){
			L[52][0] = L[52][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit52_1[i][4]==0){
			L[52][1] = L[52][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<5;i++){
		...
		if(unit53_0[i][4]==0){
			L[53][0] = L[53][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit53_1[i][4]==0){
			L[53][1] = L[53][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit54_0[i][4]==0){
			L[54][0] = L[54][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit54_1[i][4]==0){
			L[54][1] = L[54][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit55_0[i][4]==0){
			L[55][0] = L[55][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit55_1[i][4]==0){
			L[55][1] = L[55][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit56_0[i][4]==0){
			L[56][0] = L[56][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit56_1[i][4]==0){
			L[56][1] = L[56][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit57_0[i][4]==0){
			L[57][0] = L[57][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit57_1[i][4]==0){
			L[57][1] = L[57][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit58_0[i][4]==0){
			L[58][0] = L[58][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit58_1[i][4]==0){
			L[58][1] = L[58][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit59_0[i][4]==0){
			L[59][0] = L[59][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit59_1[i][4]==0){
			L[59][1] = L[59][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit60_0[i][4]==0){
			L[60][0] = L[60][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit60_1[i][4]==0){
			L[60][1] = L[60][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit61_0[i][4]==0){
			L[61][0] = L[61][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit61_1[i][4]==0){
			L[61][1] = L[61][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit62_0[i][4]==0){
			L[62][0] = L[62][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit62_1[i][4]==0){
			L[62][1] = L[62][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit63_0[i][4]==0){
			L[63][0] = L[63][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit63_1[i][4]==0){
			L[63][1] = L[63][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit64_0[i][4]==0){
			L[64][0] = L[64][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit64_1[i][4]==0){
			L[64][1] = L[64][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit65_0[i][4]==0){
			L[65][0] = L[65][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit65_1[i][4]==0){
			L[65][1] = L[65][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit66_0[i][4]==0){
			L[66][0] = L[66][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit66_1[i][4]==0){
			L[66][1] = L[66][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit67_0[i][4]==0){
			L[67][0] = L[67][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<4;i++){
		...
		if(unit67_1[i][4]==0){
			L[67][1] = L[67][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit68_0[i][4]==0){
			L[68][0] = L[68][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit68_1[i][4]==0){
			L[68][1] = L[68][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit69_0[i][4]==0){
			L[69][0] = L[69][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit69_1[i][4]==0){
			L[69][1] = L[69][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<4;i++){
		...
		if(unit70_0[i][4]==0){
			L[70][0] = L[70][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<10;i++){
		...
		if(unit70_1[i][4]==0){
			L[70][1] = L[70][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit71_0[i][4]==0){
			L[71][0] = L[71][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<17;i++){
		...
		if(unit71_1[i][4]==0){
			L[71][1] = L[71][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<10;i++){
		...
		if(unit72_0[i][4]==0){
			L[72][0] = L[72][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit72_1[i][4]==0){
			L[72][1] = L[72][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit73_0[i][4]==0){
			L[73][0] = L[73][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<13;i++){
		...
		if(unit73_1[i][4]==0){
			L[73][1] = L[73][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<8;i++){
		...
		if(unit74_0[i][4]==0){
			L[74][0] = L[74][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit74_1[i][4]==0){
			L[74][1] = L[74][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<3;i++){
		...
		if(unit75_0[i][4]==0){
			L[75][0] = L[75][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<16;i++){
		...
		if(unit75_1[i][4]==0){
			L[75][1] = L[75][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<8;i++){
		...
		if(unit76_0[i][4]==0){
			L[76][0] = L[76][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<17;i++){
		...
		if(unit76_1[i][4]==0){
			L[76][1] = L[76][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<10;i++){
		...
		if(unit77_0[i][4]==0){
			L[77][0] = L[77][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<13;i++){
		...
		if(unit77_1[i][4]==0){
			L[77][1] = L[77][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit78_0[i][4]==0){
			L[78][0] = L[78][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit78_1[i][4]==0){
			L[78][1] = L[78][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit79_0[i][4]==0){
			L[79][0] = L[79][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<15;i++){
		...
		if(unit79_1[i][4]==0){
			L[79][1] = L[79][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<3;i++){
		...
		if(unit80_0[i][4]==0){
			L[80][0] = L[80][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<16;i++){
		...
		if(unit80_1[i][4]==0){
			L[80][1] = L[80][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit81_0[i][4]==0){
			L[81][0] = L[81][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit81_1[i][4]==0){
			L[81][1] = L[81][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit82_0[i][4]==0){
			L[82][0] = L[82][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<9;i++){
		...
		if(unit82_1[i][4]==0){
			L[82][1] = L[82][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<5;i++){
		...
		if(unit83_0[i][4]==0){
			L[83][0] = L[83][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<11;i++){
		...
		if(unit83_1[i][4]==0){
			L[83][1] = L[83][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit84_0[i][4]==0){
			L[84][0] = L[84][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit84_1[i][4]==0){
			L[84][1] = L[84][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit85_0[i][4]==0){
			L[85][0] = L[85][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<7;i++){
		...
		if(unit85_1[i][4]==0){
			L[85][1] = L[85][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit86_0[i][4]==0){
			L[86][0] = L[86][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit86_1[i][4]==0){
			L[86][1] = L[86][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit87_0[i][4]==0){
			L[87][0] = L[87][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit87_1[i][4]==0){
			L[87][1] = L[87][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit88_0[i][4]==0){
			L[88][0] = L[88][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit88_1[i][4]==0){
			L[88][1] = L[88][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit89_0[i][4]==0){
			L[89][0] = L[89][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit89_1[i][4]==0){
			L[89][1] = L[89][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit90_0[i][4]==0){
			L[90][0] = L[90][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit90_1[i][4]==0){
			L[90][1] = L[90][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit91_0[i][4]==0){
			L[91][0] = L[91][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit91_1[i][4]==0){
			L[91][1] = L[91][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit92_0[i][4]==0){
			L[92][0] = L[92][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit92_1[i][4]==0){
			L[92][1] = L[92][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit93_0[i][4]==0){
			L[93][0] = L[93][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit93_1[i][4]==0){
			L[93][1] = L[93][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit94_0[i][4]==0){
			L[94][0] = L[94][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit94_1[i][4]==0){
			L[94][1] = L[94][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit95_0[i][4]==0){
			L[95][0] = L[95][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit95_1[i][4]==0){
			L[95][1] = L[95][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<4;i++){
		...
		if(unit96_0[i][4]==0){
			L[96][0] = L[96][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit96_1[i][4]==0){
			L[96][1] = L[96][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<5;i++){
		...
		if(unit97_0[i][4]==0){
			L[97][0] = L[97][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<4;i++){
		...
		if(unit97_1[i][4]==0){
			L[97][1] = L[97][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit98_0[i][4]==0){
			L[98][0] = L[98][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit98_1[i][4]==0){
			L[98][1] = L[98][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<4;i++){
		...
		if(unit99_0[i][4]==0){
			L[99][0] = L[99][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<6;i++){
		...
		if(unit99_1[i][4]==0){
			L[99][1] = L[99][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<1;i++){
		...
		if(unit100_1[i][4]==0){
			L[100][1] = L[100][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit251_0[i][4]==0){
			L[251][0] = L[251][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit251_1[i][4]==0){
			L[251][1] = L[251][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit252_0[i][4]==0){
			L[252][0] = L[252][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit252_1[i][4]==0){
			L[252][1] = L[252][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit253_0[i][4]==0){
			L[253][0] = L[253][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit253_1[i][4]==0){
			L[253][1] = L[253][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit254_0[i][4]==0){
			L[254][0] = L[254][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit254_1[i][4]==0){
			L[254][1] = L[254][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit255_0[i][4]==0){
			L[255][0] = L[255][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit255_1[i][4]==0){
			L[255][1] = L[255][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit256_0[i][4]==0){
			L[256][0] = L[256][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit256_1[i][4]==0){
			L[256][1] = L[256][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit257_0[i][4]==0){
			L[257][0] = L[257][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit257_1[i][4]==0){
			L[257][1] = L[257][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit258_0[i][4]==0){
			L[258][0] = L[258][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit258_1[i][4]==0){
			L[258][1] = L[258][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit259_0[i][4]==0){
			L[259][0] = L[259][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit259_1[i][4]==0){
			L[259][1] = L[259][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit260_0[i][4]==0){
			L[260][0] = L[260][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit260_1[i][4]==0){
			L[260][1] = L[260][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit261_0[i][4]==0){
			L[261][0] = L[261][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit261_1[i][4]==0){
			L[261][1] = L[261][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit262_0[i][4]==0){
			L[262][0] = L[262][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit262_1[i][4]==0){
			L[262][1] = L[262][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit263_0[i][4]==0){
			L[263][0] = L[263][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit263_1[i][4]==0){
			L[263][1] = L[263][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit264_0[i][4]==0){
			L[264][0] = L[264][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit264_1[i][4]==0){
			L[264][1] = L[264][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit265_0[i][4]==0){
			L[265][0] = L[265][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit265_1[i][4]==0){
			L[265][1] = L[265][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit266_0[i][4]==0){
			L[266][0] = L[266][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit266_1[i][4]==0){
			L[266][1] = L[266][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit267_0[i][4]==0){
			L[267][0] = L[267][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit267_1[i][4]==0){
			L[267][1] = L[267][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit268_0[i][4]==0){
			L[268][0] = L[268][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit268_1[i][4]==0){
			L[268][1] = L[268][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit269_0[i][4]==0){
			L[269][0] = L[269][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit269_1[i][4]==0){
			L[269][1] = L[269][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit270_0[i][4]==0){
			L[270][0] = L[270][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit270_1[i][4]==0){
			L[270][1] = L[270][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit271_0[i][4]==0){
			L[271][0] = L[271][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit271_1[i][4]==0){
			L[271][1] = L[271][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit272_0[i][4]==0){
			L[272][0] = L[272][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit272_1[i][4]==0){
			L[272][1] = L[272][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit273_0[i][4]==0){
			L[273][0] = L[273][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit273_1[i][4]==0){
			L[273][1] = L[273][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit274_0[i][4]==0){
			L[274][0] = L[274][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit274_1[i][4]==0){
			L[274][1] = L[274][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit275_0[i][4]==0){
			L[275][0] = L[275][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit275_1[i][4]==0){
			L[275][1] = L[275][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit276_0[i][4]==0){
			L[276][0] = L[276][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit276_1[i][4]==0){
			L[276][1] = L[276][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit277_0[i][4]==0){
			L[277][0] = L[277][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit277_1[i][4]==0){
			L[277][1] = L[277][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit278_0[i][4]==0){
			L[278][0] = L[278][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit278_1[i][4]==0){
			L[278][1] = L[278][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit279_0[i][4]==0){
			L[279][0] = L[279][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit279_1[i][4]==0){
			L[279][1] = L[279][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit280_0[i][4]==0){
			L[280][0] = L[280][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit280_1[i][4]==0){
			L[280][1] = L[280][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit281_0[i][4]==0){
			L[281][0] = L[281][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit281_1[i][4]==0){
			L[281][1] = L[281][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit282_0[i][4]==0){
			L[282][0] = L[282][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit282_1[i][4]==0){
			L[282][1] = L[282][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit283_0[i][4]==0){
			L[283][0] = L[283][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit283_1[i][4]==0){
			L[283][1] = L[283][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit284_0[i][4]==0){
			L[284][0] = L[284][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit284_1[i][4]==0){
			L[284][1] = L[284][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit285_0[i][4]==0){
			L[285][0] = L[285][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit285_1[i][4]==0){
			L[285][1] = L[285][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit286_0[i][4]==0){
			L[286][0] = L[286][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit286_1[i][4]==0){
			L[286][1] = L[286][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit287_0[i][4]==0){
			L[287][0] = L[287][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit287_1[i][4]==0){
			L[287][1] = L[287][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit288_0[i][4]==0){
			L[288][0] = L[288][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit288_1[i][4]==0){
			L[288][1] = L[288][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit289_0[i][4]==0){
			L[289][0] = L[289][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit289_1[i][4]==0){
			L[289][1] = L[289][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit290_0[i][4]==0){
			L[290][0] = L[290][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit290_1[i][4]==0){
			L[290][1] = L[290][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit291_0[i][4]==0){
			L[291][0] = L[291][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit291_1[i][4]==0){
			L[291][1] = L[291][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit292_0[i][4]==0){
			L[292][0] = L[292][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit292_1[i][4]==0){
			L[292][1] = L[292][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit293_0[i][4]==0){
			L[293][0] = L[293][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit293_1[i][4]==0){
			L[293][1] = L[293][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit294_0[i][4]==0){
			L[294][0] = L[294][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit294_1[i][4]==0){
			L[294][1] = L[294][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit295_0[i][4]==0){
			L[295][0] = L[295][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit295_1[i][4]==0){
			L[295][1] = L[295][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit296_0[i][4]==0){
			L[296][0] = L[296][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit296_1[i][4]==0){
			L[296][1] = L[296][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit297_0[i][4]==0){
			L[297][0] = L[297][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit297_1[i][4]==0){
			L[297][1] = L[297][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit298_0[i][4]==0){
			L[298][0] = L[298][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit298_1[i][4]==0){
			L[298][1] = L[298][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit299_0[i][4]==0){
			L[299][0] = L[299][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit299_1[i][4]==0){
			L[299][1] = L[299][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit300_0[i][4]==0){
			L[300][0] = L[300][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit300_1[i][4]==0){
			L[300][1] = L[300][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit301_0[i][4]==0){
			L[301][0] = L[301][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit301_1[i][4]==0){
			L[301][1] = L[301][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit302_0[i][4]==0){
			L[302][0] = L[302][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit302_1[i][4]==0){
			L[302][1] = L[302][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit303_0[i][4]==0){
			L[303][0] = L[303][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit303_1[i][4]==0){
			L[303][1] = L[303][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit304_0[i][4]==0){
			L[304][0] = L[304][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit304_1[i][4]==0){
			L[304][1] = L[304][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit305_0[i][4]==0){
			L[305][0] = L[305][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit305_1[i][4]==0){
			L[305][1] = L[305][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit306_0[i][4]==0){
			L[306][0] = L[306][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit306_1[i][4]==0){
			L[306][1] = L[306][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit307_0[i][4]==0){
			L[307][0] = L[307][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit307_1[i][4]==0){
			L[307][1] = L[307][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit308_0[i][4]==0){
			L[308][0] = L[308][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit308_1[i][4]==0){
			L[308][1] = L[308][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit309_0[i][4]==0){
			L[309][0] = L[309][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit309_1[i][4]==0){
			L[309][1] = L[309][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit310_0[i][4]==0){
			L[310][0] = L[310][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit310_1[i][4]==0){
			L[310][1] = L[310][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit311_0[i][4]==0){
			L[311][0] = L[311][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit311_1[i][4]==0){
			L[311][1] = L[311][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit312_0[i][4]==0){
			L[312][0] = L[312][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit312_1[i][4]==0){
			L[312][1] = L[312][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit313_0[i][4]==0){
			L[313][0] = L[313][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit313_1[i][4]==0){
			L[313][1] = L[313][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit314_0[i][4]==0){
			L[314][0] = L[314][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit314_1[i][4]==0){
			L[314][1] = L[314][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit315_0[i][4]==0){
			L[315][0] = L[315][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit315_1[i][4]==0){
			L[315][1] = L[315][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit316_0[i][4]==0){
			L[316][0] = L[316][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit316_1[i][4]==0){
			L[316][1] = L[316][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit317_0[i][4]==0){
			L[317][0] = L[317][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit317_1[i][4]==0){
			L[317][1] = L[317][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit318_0[i][4]==0){
			L[318][0] = L[318][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit318_1[i][4]==0){
			L[318][1] = L[318][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit319_0[i][4]==0){
			L[319][0] = L[319][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit319_1[i][4]==0){
			L[319][1] = L[319][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit320_0[i][4]==0){
			L[320][0] = L[320][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit320_1[i][4]==0){
			L[320][1] = L[320][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit321_0[i][4]==0){
			L[321][0] = L[321][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit321_1[i][4]==0){
			L[321][1] = L[321][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit322_0[i][4]==0){
			L[322][0] = L[322][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit322_1[i][4]==0){
			L[322][1] = L[322][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit323_0[i][4]==0){
			L[323][0] = L[323][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit323_1[i][4]==0){
			L[323][1] = L[323][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit324_0[i][4]==0){
			L[324][0] = L[324][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit324_1[i][4]==0){
			L[324][1] = L[324][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit325_0[i][4]==0){
			L[325][0] = L[325][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit325_1[i][4]==0){
			L[325][1] = L[325][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit326_0[i][4]==0){
			L[326][0] = L[326][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit326_1[i][4]==0){
			L[326][1] = L[326][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit327_0[i][4]==0){
			L[327][0] = L[327][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit327_1[i][4]==0){
			L[327][1] = L[327][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit328_0[i][4]==0){
			L[328][0] = L[328][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit328_1[i][4]==0){
			L[328][1] = L[328][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit329_0[i][4]==0){
			L[329][0] = L[329][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit329_1[i][4]==0){
			L[329][1] = L[329][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit330_0[i][4]==0){
			L[330][0] = L[330][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit330_1[i][4]==0){
			L[330][1] = L[330][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit331_0[i][4]==0){
			L[331][0] = L[331][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit331_1[i][4]==0){
			L[331][1] = L[331][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit332_0[i][4]==0){
			L[332][0] = L[332][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit332_1[i][4]==0){
			L[332][1] = L[332][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit333_0[i][4]==0){
			L[333][0] = L[333][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit333_1[i][4]==0){
			L[333][1] = L[333][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit334_0[i][4]==0){
			L[334][0] = L[334][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit334_1[i][4]==0){
			L[334][1] = L[334][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit335_0[i][4]==0){
			L[335][0] = L[335][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit335_1[i][4]==0){
			L[335][1] = L[335][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit336_0[i][4]==0){
			L[336][0] = L[336][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit336_1[i][4]==0){
			L[336][1] = L[336][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit337_0[i][4]==0){
			L[337][0] = L[337][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit337_1[i][4]==0){
			L[337][1] = L[337][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit338_0[i][4]==0){
			L[338][0] = L[338][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit338_1[i][4]==0){
			L[338][1] = L[338][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit339_0[i][4]==0){
			L[339][0] = L[339][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit339_1[i][4]==0){
			L[339][1] = L[339][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit340_0[i][4]==0){
			L[340][0] = L[340][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit340_1[i][4]==0){
			L[340][1] = L[340][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit341_0[i][4]==0){
			L[341][0] = L[341][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit341_1[i][4]==0){
			L[341][1] = L[341][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit342_0[i][4]==0){
			L[342][0] = L[342][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit342_1[i][4]==0){
			L[342][1] = L[342][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit343_0[i][4]==0){
			L[343][0] = L[343][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit343_1[i][4]==0){
			L[343][1] = L[343][1] | (X_contra01 & X_contra23);
...
<<<<<<< HEAD
	...
	for(int i=0;i<0;i++){
		...
		if(unit344_0[i][4]==0){
			L[344][0] = L[344][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit344_1[i][4]==0){
			L[344][1] = L[344][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit345_0[i][4]==0){
			L[345][0] = L[345][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit345_1[i][4]==0){
			L[345][1] = L[345][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit346_0[i][4]==0){
			L[346][0] = L[346][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit346_1[i][4]==0){
			L[346][1] = L[346][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit347_0[i][4]==0){
			L[347][0] = L[347][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit347_1[i][4]==0){
			L[347][1] = L[347][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit348_0[i][4]==0){
			L[348][0] = L[348][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit348_1[i][4]==0){
			L[348][1] = L[348][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit349_0[i][4]==0){
			L[349][0] = L[349][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit349_1[i][4]==0){
			L[349][1] = L[349][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit350_0[i][4]==0){
			L[350][0] = L[350][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit350_1[i][4]==0){
			L[350][1] = L[350][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit351_0[i][4]==0){
			L[351][0] = L[351][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit351_1[i][4]==0){
			L[351][1] = L[351][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit352_0[i][4]==0){
			L[352][0] = L[352][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit352_1[i][4]==0){
			L[352][1] = L[352][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit353_0[i][4]==0){
			L[353][0] = L[353][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit353_1[i][4]==0){
			L[353][1] = L[353][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit354_0[i][4]==0){
			L[354][0] = L[354][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit354_1[i][4]==0){
			L[354][1] = L[354][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit355_0[i][4]==0){
			L[355][0] = L[355][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit355_1[i][4]==0){
			L[355][1] = L[355][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit356_0[i][4]==0){
			L[356][0] = L[356][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit356_1[i][4]==0){
			L[356][1] = L[356][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit357_0[i][4]==0){
			L[357][0] = L[357][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit357_1[i][4]==0){
			L[357][1] = L[357][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit358_0[i][4]==0){
			L[358][0] = L[358][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit358_1[i][4]==0){
			L[358][1] = L[358][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit359_0[i][4]==0){
			L[359][0] = L[359][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit359_1[i][4]==0){
			L[359][1] = L[359][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit360_0[i][4]==0){
			L[360][0] = L[360][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit360_1[i][4]==0){
			L[360][1] = L[360][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit361_0[i][4]==0){
			L[361][0] = L[361][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit361_1[i][4]==0){
			L[361][1] = L[361][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit362_0[i][4]==0){
			L[362][0] = L[362][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit362_1[i][4]==0){
			L[362][1] = L[362][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit363_0[i][4]==0){
			L[363][0] = L[363][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit363_1[i][4]==0){
			L[363][1] = L[363][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit364_0[i][4]==0){
			L[364][0] = L[364][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit364_1[i][4]==0){
			L[364][1] = L[364][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit365_0[i][4]==0){
			L[365][0] = L[365][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit365_1[i][4]==0){
			L[365][1] = L[365][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit366_0[i][4]==0){
			L[366][0] = L[366][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit366_1[i][4]==0){
			L[366][1] = L[366][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit367_0[i][4]==0){
			L[367][0] = L[367][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit367_1[i][4]==0){
			L[367][1] = L[367][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit368_0[i][4]==0){
			L[368][0] = L[368][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit368_1[i][4]==0){
			L[368][1] = L[368][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit369_0[i][4]==0){
			L[369][0] = L[369][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit369_1[i][4]==0){
			L[369][1] = L[369][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit370_0[i][4]==0){
			L[370][0] = L[370][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit370_1[i][4]==0){
			L[370][1] = L[370][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit371_0[i][4]==0){
			L[371][0] = L[371][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit371_1[i][4]==0){
			L[371][1] = L[371][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit372_0[i][4]==0){
			L[372][0] = L[372][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit372_1[i][4]==0){
			L[372][1] = L[372][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit373_0[i][4]==0){
			L[373][0] = L[373][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit373_1[i][4]==0){
			L[373][1] = L[373][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit374_0[i][4]==0){
			L[374][0] = L[374][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit374_1[i][4]==0){
			L[374][1] = L[374][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit375_0[i][4]==0){
			L[375][0] = L[375][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit375_1[i][4]==0){
			L[375][1] = L[375][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit376_0[i][4]==0){
			L[376][0] = L[376][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit376_1[i][4]==0){
			L[376][1] = L[376][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit377_0[i][4]==0){
			L[377][0] = L[377][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit377_1[i][4]==0){
			L[377][1] = L[377][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit378_0[i][4]==0){
			L[378][0] = L[378][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit378_1[i][4]==0){
			L[378][1] = L[378][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit379_0[i][4]==0){
			L[379][0] = L[379][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit379_1[i][4]==0){
			L[379][1] = L[379][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit380_0[i][4]==0){
			L[380][0] = L[380][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit380_1[i][4]==0){
			L[380][1] = L[380][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit381_0[i][4]==0){
			L[381][0] = L[381][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit381_1[i][4]==0){
			L[381][1] = L[381][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit382_0[i][4]==0){
			L[382][0] = L[382][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit382_1[i][4]==0){
			L[382][1] = L[382][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit383_0[i][4]==0){
			L[383][0] = L[383][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit383_1[i][4]==0){
			L[383][1] = L[383][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit384_0[i][4]==0){
			L[384][0] = L[384][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit384_1[i][4]==0){
			L[384][1] = L[384][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit385_0[i][4]==0){
			L[385][0] = L[385][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit385_1[i][4]==0){
			L[385][1] = L[385][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit386_0[i][4]==0){
			L[386][0] = L[386][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit386_1[i][4]==0){
			L[386][1] = L[386][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit387_0[i][4]==0){
			L[387][0] = L[387][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit387_1[i][4]==0){
			L[387][1] = L[387][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit388_0[i][4]==0){
			L[388][0] = L[388][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit388_1[i][4]==0){
			L[388][1] = L[388][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit389_0[i][4]==0){
			L[389][0] = L[389][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit389_1[i][4]==0){
			L[389][1] = L[389][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit390_0[i][4]==0){
			L[390][0] = L[390][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit390_1[i][4]==0){
			L[390][1] = L[390][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit391_0[i][4]==0){
			L[391][0] = L[391][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit391_1[i][4]==0){
			L[391][1] = L[391][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit392_0[i][4]==0){
			L[392][0] = L[392][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit392_1[i][4]==0){
			L[392][1] = L[392][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit393_0[i][4]==0){
			L[393][0] = L[393][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit393_1[i][4]==0){
			L[393][1] = L[393][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit394_0[i][4]==0){
			L[394][0] = L[394][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit394_1[i][4]==0){
			L[394][1] = L[394][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit395_0[i][4]==0){
			L[395][0] = L[395][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit395_1[i][4]==0){
			L[395][1] = L[395][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit396_0[i][4]==0){
			L[396][0] = L[396][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit396_1[i][4]==0){
			L[396][1] = L[396][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit397_0[i][4]==0){
			L[397][0] = L[397][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit397_1[i][4]==0){
			L[397][1] = L[397][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit398_0[i][4]==0){
			L[398][0] = L[398][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit398_1[i][4]==0){
			L[398][1] = L[398][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit399_0[i][4]==0){
			L[399][0] = L[399][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit399_1[i][4]==0){
			L[399][1] = L[399][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit400_0[i][4]==0){
			L[400][0] = L[400][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit400_1[i][4]==0){
			L[400][1] = L[400][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit401_0[i][4]==0){
			L[401][0] = L[401][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit401_1[i][4]==0){
			L[401][1] = L[401][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit402_0[i][4]==0){
			L[402][0] = L[402][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit402_1[i][4]==0){
			L[402][1] = L[402][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit403_0[i][4]==0){
			L[403][0] = L[403][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit403_1[i][4]==0){
			L[403][1] = L[403][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit404_0[i][4]==0){
			L[404][0] = L[404][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit404_1[i][4]==0){
			L[404][1] = L[404][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit405_0[i][4]==0){
			L[405][0] = L[405][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit405_1[i][4]==0){
			L[405][1] = L[405][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit406_0[i][4]==0){
			L[406][0] = L[406][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit406_1[i][4]==0){
			L[406][1] = L[406][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit407_0[i][4]==0){
			L[407][0] = L[407][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit407_1[i][4]==0){
			L[407][1] = L[407][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit408_0[i][4]==0){
			L[408][0] = L[408][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit408_1[i][4]==0){
			L[408][1] = L[408][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit409_0[i][4]==0){
			L[409][0] = L[409][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit409_1[i][4]==0){
			L[409][1] = L[409][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit410_0[i][4]==0){
			L[410][0] = L[410][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit410_1[i][4]==0){
			L[410][1] = L[410][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit411_0[i][4]==0){
			L[411][0] = L[411][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit411_1[i][4]==0){
			L[411][1] = L[411][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit412_0[i][4]==0){
			L[412][0] = L[412][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit412_1[i][4]==0){
			L[412][1] = L[412][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit413_0[i][4]==0){
			L[413][0] = L[413][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit413_1[i][4]==0){
			L[413][1] = L[413][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit414_0[i][4]==0){
			L[414][0] = L[414][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit414_1[i][4]==0){
			L[414][1] = L[414][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit415_0[i][4]==0){
			L[415][0] = L[415][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit415_1[i][4]==0){
			L[415][1] = L[415][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit416_0[i][4]==0){
			L[416][0] = L[416][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit416_1[i][4]==0){
			L[416][1] = L[416][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit417_0[i][4]==0){
			L[417][0] = L[417][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit417_1[i][4]==0){
			L[417][1] = L[417][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit418_0[i][4]==0){
			L[418][0] = L[418][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit418_1[i][4]==0){
			L[418][1] = L[418][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit419_0[i][4]==0){
			L[419][0] = L[419][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit419_1[i][4]==0){
			L[419][1] = L[419][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit420_0[i][4]==0){
			L[420][0] = L[420][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit420_1[i][4]==0){
			L[420][1] = L[420][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit421_0[i][4]==0){
			L[421][0] = L[421][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit421_1[i][4]==0){
			L[421][1] = L[421][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit422_0[i][4]==0){
			L[422][0] = L[422][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit422_1[i][4]==0){
			L[422][1] = L[422][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit423_0[i][4]==0){
			L[423][0] = L[423][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit423_1[i][4]==0){
			L[423][1] = L[423][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit424_0[i][4]==0){
			L[424][0] = L[424][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit424_1[i][4]==0){
			L[424][1] = L[424][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit425_0[i][4]==0){
			L[425][0] = L[425][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit425_1[i][4]==0){
			L[425][1] = L[425][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit426_0[i][4]==0){
			L[426][0] = L[426][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit426_1[i][4]==0){
			L[426][1] = L[426][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit427_0[i][4]==0){
			L[427][0] = L[427][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit427_1[i][4]==0){
			L[427][1] = L[427][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit428_0[i][4]==0){
			L[428][0] = L[428][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit428_1[i][4]==0){
			L[428][1] = L[428][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit429_0[i][4]==0){
			L[429][0] = L[429][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit429_1[i][4]==0){
			L[429][1] = L[429][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit430_0[i][4]==0){
			L[430][0] = L[430][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit430_1[i][4]==0){
			L[430][1] = L[430][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit431_0[i][4]==0){
			L[431][0] = L[431][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit431_1[i][4]==0){
			L[431][1] = L[431][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit432_0[i][4]==0){
			L[432][0] = L[432][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit432_1[i][4]==0){
			L[432][1] = L[432][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit433_0[i][4]==0){
			L[433][0] = L[433][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit433_1[i][4]==0){
			L[433][1] = L[433][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit434_0[i][4]==0){
			L[434][0] = L[434][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit434_1[i][4]==0){
			L[434][1] = L[434][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit435_0[i][4]==0){
			L[435][0] = L[435][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit435_1[i][4]==0){
			L[435][1] = L[435][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit436_0[i][4]==0){
			L[436][0] = L[436][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit436_1[i][4]==0){
			L[436][1] = L[436][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit437_0[i][4]==0){
			L[437][0] = L[437][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit437_1[i][4]==0){
			L[437][1] = L[437][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit438_0[i][4]==0){
			L[438][0] = L[438][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit438_1[i][4]==0){
			L[438][1] = L[438][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit439_0[i][4]==0){
			L[439][0] = L[439][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit439_1[i][4]==0){
			L[439][1] = L[439][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit440_0[i][4]==0){
			L[440][0] = L[440][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit440_1[i][4]==0){
			L[440][1] = L[440][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit441_0[i][4]==0){
			L[441][0] = L[441][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit441_1[i][4]==0){
			L[441][1] = L[441][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit442_0[i][4]==0){
			L[442][0] = L[442][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit442_1[i][4]==0){
			L[442][1] = L[442][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit443_0[i][4]==0){
			L[443][0] = L[443][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit443_1[i][4]==0){
			L[443][1] = L[443][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit444_0[i][4]==0){
			L[444][0] = L[444][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit444_1[i][4]==0){
			L[444][1] = L[444][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit445_0[i][4]==0){
			L[445][0] = L[445][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit445_1[i][4]==0){
			L[445][1] = L[445][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit446_0[i][4]==0){
			L[446][0] = L[446][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit446_1[i][4]==0){
			L[446][1] = L[446][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit447_0[i][4]==0){
			L[447][0] = L[447][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit447_1[i][4]==0){
			L[447][1] = L[447][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit448_0[i][4]==0){
			L[448][0] = L[448][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit448_1[i][4]==0){
			L[448][1] = L[448][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit449_0[i][4]==0){
			L[449][0] = L[449][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit449_1[i][4]==0){
			L[449][1] = L[449][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit450_0[i][4]==0){
			L[450][0] = L[450][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit450_1[i][4]==0){
			L[450][1] = L[450][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit451_0[i][4]==0){
			L[451][0] = L[451][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit451_1[i][4]==0){
			L[451][1] = L[451][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit452_0[i][4]==0){
			L[452][0] = L[452][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit452_1[i][4]==0){
			L[452][1] = L[452][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit453_0[i][4]==0){
			L[453][0] = L[453][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit453_1[i][4]==0){
			L[453][1] = L[453][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit454_0[i][4]==0){
			L[454][0] = L[454][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit454_1[i][4]==0){
			L[454][1] = L[454][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit455_0[i][4]==0){
			L[455][0] = L[455][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit455_1[i][4]==0){
			L[455][1] = L[455][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit456_0[i][4]==0){
			L[456][0] = L[456][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit456_1[i][4]==0){
			L[456][1] = L[456][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit457_0[i][4]==0){
			L[457][0] = L[457][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit457_1[i][4]==0){
			L[457][1] = L[457][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit458_0[i][4]==0){
			L[458][0] = L[458][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit458_1[i][4]==0){
			L[458][1] = L[458][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit459_0[i][4]==0){
			L[459][0] = L[459][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit459_1[i][4]==0){
			L[459][1] = L[459][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit460_0[i][4]==0){
			L[460][0] = L[460][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit460_1[i][4]==0){
			L[460][1] = L[460][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit461_0[i][4]==0){
			L[461][0] = L[461][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit461_1[i][4]==0){
			L[461][1] = L[461][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit462_0[i][4]==0){
			L[462][0] = L[462][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit462_1[i][4]==0){
			L[462][1] = L[462][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit463_0[i][4]==0){
			L[463][0] = L[463][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit463_1[i][4]==0){
			L[463][1] = L[463][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit464_0[i][4]==0){
			L[464][0] = L[464][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit464_1[i][4]==0){
			L[464][1] = L[464][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit465_0[i][4]==0){
			L[465][0] = L[465][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit465_1[i][4]==0){
			L[465][1] = L[465][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit466_0[i][4]==0){
			L[466][0] = L[466][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit466_1[i][4]==0){
			L[466][1] = L[466][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit467_0[i][4]==0){
			L[467][0] = L[467][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit467_1[i][4]==0){
			L[467][1] = L[467][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit468_0[i][4]==0){
			L[468][0] = L[468][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit468_1[i][4]==0){
			L[468][1] = L[468][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit469_0[i][4]==0){
			L[469][0] = L[469][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit469_1[i][4]==0){
			L[469][1] = L[469][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit470_0[i][4]==0){
			L[470][0] = L[470][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit470_1[i][4]==0){
			L[470][1] = L[470][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit471_0[i][4]==0){
			L[471][0] = L[471][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit471_1[i][4]==0){
			L[471][1] = L[471][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit472_0[i][4]==0){
			L[472][0] = L[472][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit472_1[i][4]==0){
			L[472][1] = L[472][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit473_0[i][4]==0){
			L[473][0] = L[473][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit473_1[i][4]==0){
			L[473][1] = L[473][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit474_0[i][4]==0){
			L[474][0] = L[474][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit474_1[i][4]==0){
			L[474][1] = L[474][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit475_0[i][4]==0){
			L[475][0] = L[475][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit475_1[i][4]==0){
			L[475][1] = L[475][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit476_0[i][4]==0){
			L[476][0] = L[476][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit476_1[i][4]==0){
			L[476][1] = L[476][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit477_0[i][4]==0){
			L[477][0] = L[477][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit477_1[i][4]==0){
			L[477][1] = L[477][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit478_0[i][4]==0){
			L[478][0] = L[478][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit478_1[i][4]==0){
			L[478][1] = L[478][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit479_0[i][4]==0){
			L[479][0] = L[479][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit479_1[i][4]==0){
			L[479][1] = L[479][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit480_0[i][4]==0){
			L[480][0] = L[480][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit480_1[i][4]==0){
			L[480][1] = L[480][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit481_0[i][4]==0){
			L[481][0] = L[481][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit481_1[i][4]==0){
			L[481][1] = L[481][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit482_0[i][4]==0){
			L[482][0] = L[482][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit482_1[i][4]==0){
			L[482][1] = L[482][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit483_0[i][4]==0){
			L[483][0] = L[483][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit483_1[i][4]==0){
			L[483][1] = L[483][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit484_0[i][4]==0){
			L[484][0] = L[484][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit484_1[i][4]==0){
			L[484][1] = L[484][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit485_0[i][4]==0){
			L[485][0] = L[485][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit485_1[i][4]==0){
			L[485][1] = L[485][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit486_0[i][4]==0){
			L[486][0] = L[486][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit486_1[i][4]==0){
			L[486][1] = L[486][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit487_0[i][4]==0){
			L[487][0] = L[487][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit487_1[i][4]==0){
			L[487][1] = L[487][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit488_0[i][4]==0){
			L[488][0] = L[488][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit488_1[i][4]==0){
			L[488][1] = L[488][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit489_0[i][4]==0){
			L[489][0] = L[489][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit489_1[i][4]==0){
			L[489][1] = L[489][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit490_0[i][4]==0){
			L[490][0] = L[490][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit490_1[i][4]==0){
			L[490][1] = L[490][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit491_0[i][4]==0){
			L[491][0] = L[491][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit491_1[i][4]==0){
			L[491][1] = L[491][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit492_0[i][4]==0){
			L[492][0] = L[492][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit492_1[i][4]==0){
			L[492][1] = L[492][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit493_0[i][4]==0){
			L[493][0] = L[493][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit493_1[i][4]==0){
			L[493][1] = L[493][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit494_0[i][4]==0){
			L[494][0] = L[494][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit494_1[i][4]==0){
			L[494][1] = L[494][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit495_0[i][4]==0){
			L[495][0] = L[495][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit495_1[i][4]==0){
			L[495][1] = L[495][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit496_0[i][4]==0){
			L[496][0] = L[496][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit496_1[i][4]==0){
			L[496][1] = L[496][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit497_0[i][4]==0){
			L[497][0] = L[497][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit497_1[i][4]==0){
			L[497][1] = L[497][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit498_0[i][4]==0){
			L[498][0] = L[498][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit498_1[i][4]==0){
			L[498][1] = L[498][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit499_0[i][4]==0){
			L[499][0] = L[499][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit499_1[i][4]==0){
			L[499][1] = L[499][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit500_0[i][4]==0){
			L[500][0] = L[500][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit500_1[i][4]==0){
			L[500][1] = L[500][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit501_0[i][4]==0){
			L[501][0] = L[501][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit501_1[i][4]==0){
			L[501][1] = L[501][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit502_0[i][4]==0){
			L[502][0] = L[502][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit502_1[i][4]==0){
			L[502][1] = L[502][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit503_0[i][4]==0){
			L[503][0] = L[503][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit503_1[i][4]==0){
			L[503][1] = L[503][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit504_0[i][4]==0){
			L[504][0] = L[504][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit504_1[i][4]==0){
			L[504][1] = L[504][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit505_0[i][4]==0){
			L[505][0] = L[505][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit505_1[i][4]==0){
			L[505][1] = L[505][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit506_0[i][4]==0){
			L[506][0] = L[506][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit506_1[i][4]==0){
			L[506][1] = L[506][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit507_0[i][4]==0){
			L[507][0] = L[507][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit507_1[i][4]==0){
			L[507][1] = L[507][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit508_0[i][4]==0){
			L[508][0] = L[508][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit508_1[i][4]==0){
			L[508][1] = L[508][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit509_0[i][4]==0){
			L[509][0] = L[509][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit509_1[i][4]==0){
			L[509][1] = L[509][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit510_0[i][4]==0){
			L[510][0] = L[510][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit510_1[i][4]==0){
			L[510][1] = L[510][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit511_0[i][4]==0){
			L[511][0] = L[511][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit511_1[i][4]==0){
			L[511][1] = L[511][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit512_0[i][4]==0){
			L[512][0] = L[512][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit512_1[i][4]==0){
			L[512][1] = L[512][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit513_0[i][4]==0){
			L[513][0] = L[513][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit513_1[i][4]==0){
			L[513][1] = L[513][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit514_0[i][4]==0){
			L[514][0] = L[514][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit514_1[i][4]==0){
			L[514][1] = L[514][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit515_0[i][4]==0){
			L[515][0] = L[515][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit515_1[i][4]==0){
			L[515][1] = L[515][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit516_0[i][4]==0){
			L[516][0] = L[516][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit516_1[i][4]==0){
			L[516][1] = L[516][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit517_0[i][4]==0){
			L[517][0] = L[517][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit517_1[i][4]==0){
			L[517][1] = L[517][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit518_0[i][4]==0){
			L[518][0] = L[518][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit518_1[i][4]==0){
			L[518][1] = L[518][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit519_0[i][4]==0){
			L[519][0] = L[519][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit519_1[i][4]==0){
			L[519][1] = L[519][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit520_0[i][4]==0){
			L[520][0] = L[520][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit520_1[i][4]==0){
			L[520][1] = L[520][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit521_0[i][4]==0){
			L[521][0] = L[521][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit521_1[i][4]==0){
			L[521][1] = L[521][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit522_0[i][4]==0){
			L[522][0] = L[522][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit522_1[i][4]==0){
			L[522][1] = L[522][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit523_0[i][4]==0){
			L[523][0] = L[523][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit523_1[i][4]==0){
			L[523][1] = L[523][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit524_0[i][4]==0){
			L[524][0] = L[524][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit524_1[i][4]==0){
			L[524][1] = L[524][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit525_0[i][4]==0){
			L[525][0] = L[525][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit525_1[i][4]==0){
			L[525][1] = L[525][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit526_0[i][4]==0){
			L[526][0] = L[526][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit526_1[i][4]==0){
			L[526][1] = L[526][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit527_0[i][4]==0){
			L[527][0] = L[527][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit527_1[i][4]==0){
			L[527][1] = L[527][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit528_0[i][4]==0){
			L[528][0] = L[528][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit528_1[i][4]==0){
			L[528][1] = L[528][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit529_0[i][4]==0){
			L[529][0] = L[529][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit529_1[i][4]==0){
			L[529][1] = L[529][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit530_0[i][4]==0){
			L[530][0] = L[530][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit530_1[i][4]==0){
			L[530][1] = L[530][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit531_0[i][4]==0){
			L[531][0] = L[531][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit531_1[i][4]==0){
			L[531][1] = L[531][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit532_0[i][4]==0){
			L[532][0] = L[532][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit532_1[i][4]==0){
			L[532][1] = L[532][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit533_0[i][4]==0){
			L[533][0] = L[533][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit533_1[i][4]==0){
			L[533][1] = L[533][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit534_0[i][4]==0){
			L[534][0] = L[534][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit534_1[i][4]==0){
			L[534][1] = L[534][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit535_0[i][4]==0){
			L[535][0] = L[535][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit535_1[i][4]==0){
			L[535][1] = L[535][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit536_0[i][4]==0){
			L[536][0] = L[536][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit536_1[i][4]==0){
			L[536][1] = L[536][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit537_0[i][4]==0){
			L[537][0] = L[537][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit537_1[i][4]==0){
			L[537][1] = L[537][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit538_0[i][4]==0){
			L[538][0] = L[538][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit538_1[i][4]==0){
			L[538][1] = L[538][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit539_0[i][4]==0){
			L[539][0] = L[539][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit539_1[i][4]==0){
			L[539][1] = L[539][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit540_0[i][4]==0){
			L[540][0] = L[540][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit540_1[i][4]==0){
			L[540][1] = L[540][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit541_0[i][4]==0){
			L[541][0] = L[541][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit541_1[i][4]==0){
			L[541][1] = L[541][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit542_0[i][4]==0){
			L[542][0] = L[542][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit542_1[i][4]==0){
			L[542][1] = L[542][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit543_0[i][4]==0){
			L[543][0] = L[543][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit543_1[i][4]==0){
			L[543][1] = L[543][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit544_0[i][4]==0){
			L[544][0] = L[544][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit544_1[i][4]==0){
			L[544][1] = L[544][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit545_0[i][4]==0){
			L[545][0] = L[545][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit545_1[i][4]==0){
			L[545][1] = L[545][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit546_0[i][4]==0){
			L[546][0] = L[546][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit546_1[i][4]==0){
			L[546][1] = L[546][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit547_0[i][4]==0){
			L[547][0] = L[547][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit547_1[i][4]==0){
			L[547][1] = L[547][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit548_0[i][4]==0){
			L[548][0] = L[548][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit548_1[i][4]==0){
			L[548][1] = L[548][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit549_0[i][4]==0){
			L[549][0] = L[549][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit549_1[i][4]==0){
			L[549][1] = L[549][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit550_0[i][4]==0){
			L[550][0] = L[550][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit550_1[i][4]==0){
			L[550][1] = L[550][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit551_0[i][4]==0){
			L[551][0] = L[551][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit551_1[i][4]==0){
			L[551][1] = L[551][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit552_0[i][4]==0){
			L[552][0] = L[552][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit552_1[i][4]==0){
			L[552][1] = L[552][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit553_0[i][4]==0){
			L[553][0] = L[553][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit553_1[i][4]==0){
			L[553][1] = L[553][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit554_0[i][4]==0){
			L[554][0] = L[554][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit554_1[i][4]==0){
			L[554][1] = L[554][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit555_0[i][4]==0){
			L[555][0] = L[555][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit555_1[i][4]==0){
			L[555][1] = L[555][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit556_0[i][4]==0){
			L[556][0] = L[556][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit556_1[i][4]==0){
			L[556][1] = L[556][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit557_0[i][4]==0){
			L[557][0] = L[557][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit557_1[i][4]==0){
			L[557][1] = L[557][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit558_0[i][4]==0){
			L[558][0] = L[558][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit558_1[i][4]==0){
			L[558][1] = L[558][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit559_0[i][4]==0){
			L[559][0] = L[559][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit559_1[i][4]==0){
			L[559][1] = L[559][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit560_0[i][4]==0){
			L[560][0] = L[560][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit560_1[i][4]==0){
			L[560][1] = L[560][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit561_0[i][4]==0){
			L[561][0] = L[561][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit561_1[i][4]==0){
			L[561][1] = L[561][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit562_0[i][4]==0){
			L[562][0] = L[562][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit562_1[i][4]==0){
			L[562][1] = L[562][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit563_0[i][4]==0){
			L[563][0] = L[563][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit563_1[i][4]==0){
			L[563][1] = L[563][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit564_0[i][4]==0){
			L[564][0] = L[564][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit564_1[i][4]==0){
			L[564][1] = L[564][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit565_0[i][4]==0){
			L[565][0] = L[565][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit565_1[i][4]==0){
			L[565][1] = L[565][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit566_0[i][4]==0){
			L[566][0] = L[566][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit566_1[i][4]==0){
			L[566][1] = L[566][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit567_0[i][4]==0){
			L[567][0] = L[567][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit567_1[i][4]==0){
			L[567][1] = L[567][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit568_0[i][4]==0){
			L[568][0] = L[568][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit568_1[i][4]==0){
			L[568][1] = L[568][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit569_0[i][4]==0){
			L[569][0] = L[569][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit569_1[i][4]==0){
			L[569][1] = L[569][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit570_0[i][4]==0){
			L[570][0] = L[570][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit570_1[i][4]==0){
			L[570][1] = L[570][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit571_0[i][4]==0){
			L[571][0] = L[571][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit571_1[i][4]==0){
			L[571][1] = L[571][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit572_0[i][4]==0){
			L[572][0] = L[572][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit572_1[i][4]==0){
			L[572][1] = L[572][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit573_0[i][4]==0){
			L[573][0] = L[573][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit573_1[i][4]==0){
			L[573][1] = L[573][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit574_0[i][4]==0){
			L[574][0] = L[574][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit574_1[i][4]==0){
			L[574][1] = L[574][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit575_0[i][4]==0){
			L[575][0] = L[575][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit575_1[i][4]==0){
			L[575][1] = L[575][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit576_0[i][4]==0){
			L[576][0] = L[576][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit576_1[i][4]==0){
			L[576][1] = L[576][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit577_0[i][4]==0){
			L[577][0] = L[577][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit577_1[i][4]==0){
			L[577][1] = L[577][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit578_0[i][4]==0){
			L[578][0] = L[578][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit578_1[i][4]==0){
			L[578][1] = L[578][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit579_0[i][4]==0){
			L[579][0] = L[579][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit579_1[i][4]==0){
			L[579][1] = L[579][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit580_0[i][4]==0){
			L[580][0] = L[580][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit580_1[i][4]==0){
			L[580][1] = L[580][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit581_0[i][4]==0){
			L[581][0] = L[581][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit581_1[i][4]==0){
			L[581][1] = L[581][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit582_0[i][4]==0){
			L[582][0] = L[582][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit582_1[i][4]==0){
			L[582][1] = L[582][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit583_0[i][4]==0){
			L[583][0] = L[583][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit583_1[i][4]==0){
			L[583][1] = L[583][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit584_0[i][4]==0){
			L[584][0] = L[584][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit584_1[i][4]==0){
			L[584][1] = L[584][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit585_0[i][4]==0){
			L[585][0] = L[585][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit585_1[i][4]==0){
			L[585][1] = L[585][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit586_0[i][4]==0){
			L[586][0] = L[586][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit586_1[i][4]==0){
			L[586][1] = L[586][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit587_0[i][4]==0){
			L[587][0] = L[587][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit587_1[i][4]==0){
			L[587][1] = L[587][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit588_0[i][4]==0){
			L[588][0] = L[588][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit588_1[i][4]==0){
			L[588][1] = L[588][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit589_0[i][4]==0){
			L[589][0] = L[589][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit589_1[i][4]==0){
			L[589][1] = L[589][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit590_0[i][4]==0){
			L[590][0] = L[590][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit590_1[i][4]==0){
			L[590][1] = L[590][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit591_0[i][4]==0){
			L[591][0] = L[591][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit591_1[i][4]==0){
			L[591][1] = L[591][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit592_0[i][4]==0){
			L[592][0] = L[592][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit592_1[i][4]==0){
			L[592][1] = L[592][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit593_0[i][4]==0){
			L[593][0] = L[593][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit593_1[i][4]==0){
			L[593][1] = L[593][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit594_0[i][4]==0){
			L[594][0] = L[594][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit594_1[i][4]==0){
			L[594][1] = L[594][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit595_0[i][4]==0){
			L[595][0] = L[595][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit595_1[i][4]==0){
			L[595][1] = L[595][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit596_0[i][4]==0){
			L[596][0] = L[596][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit596_1[i][4]==0){
			L[596][1] = L[596][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit597_0[i][4]==0){
			L[597][0] = L[597][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit597_1[i][4]==0){
			L[597][1] = L[597][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit598_0[i][4]==0){
			L[598][0] = L[598][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit598_1[i][4]==0){
			L[598][1] = L[598][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit599_0[i][4]==0){
			L[599][0] = L[599][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit599_1[i][4]==0){
			L[599][1] = L[599][1] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit600_0[i][4]==0){
			L[600][0] = L[600][0] | (X_contra01 & X_contra23);
	...
	for(int i=0;i<0;i++){
		...
		if(unit600_1[i][4]==0){
			L[600][1] = L[600][1] | (X_contra01 & X_contra23);
