...
void update_L(two_bit_t L[N_VARIABLE+1][2], largeX_t LargeX[N_VARIABLE+1][2], one_bit_t x[N_VARIABLE+1], one_bit_t satisfiable[N_VARIABLE+1][2]){
	...
	for(int i=0;i<9;i++){
		...
		if(unit1_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[1][1]=0; L[1][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit1_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[1][0]=0; L[1][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit2_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[2][1]=0; L[2][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit2_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[2][0]=0; L[2][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit3_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[3][1]=0; L[3][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit3_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[3][0]=0; L[3][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit4_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[4][1]=0; L[4][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit4_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[4][0]=0; L[4][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit5_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[5][1]=0; L[5][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit5_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[5][0]=0; L[5][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit6_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[6][1]=0; L[6][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit6_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[6][0]=0; L[6][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit9_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[9][1]=0; L[9][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit9_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[9][0]=0; L[9][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit10_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[10][1]=0; L[10][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit10_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[10][0]=0; L[10][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit12_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[12][1]=0; L[12][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit12_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[12][0]=0; L[12][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit41_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[41][1]=0; L[41][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit41_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[41][0]=0; L[41][1]=1;}
	...
	for(int i=0;i<6;i++){
		...
		if(unit42_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[42][1]=0; L[42][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit42_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[42][0]=0; L[42][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit45_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[45][1]=0; L[45][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit45_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[45][0]=0; L[45][1]=1;}
	...
	for(int i=0;i<9;i++){
		...
		if(unit46_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[46][1]=0; L[46][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit46_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[46][0]=0; L[46][1]=1;}
	...
	for(int i=0;i<6;i++){
		...
		if(unit48_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[48][1]=0; L[48][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit48_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[48][0]=0; L[48][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit83_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[83][1]=0; L[83][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit83_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[83][0]=0; L[83][1]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit84_0[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[84][1]=0; L[84][0]=1;}
	...
	for(int i=0;i<12;i++){
		...
		if(unit84_1[i][4]==0){
				if((X_contra01 & X_contra23)>0) {L[84][0]=0; L[84][1]=1;}
