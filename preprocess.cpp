...
void generate_contra(){
    ...
    for(i=0;i<counter_new;i++){
        ...
        //-------------print contra into contra array and contra_sign array
        if(i!=(counter_new-1)){
        ...
        //-------------print reshaped array contra into 1d
        /*if(i!=(counter_new-1)){
            fprintf(fp2, "%d, %d, %d, %d,\n", contra_new[i][0]+contra_new[i][1]*N_VARIABLE, 
                contra_new[i][2]+contra_new[i][3]*N_VARIABLE, 
                contra_new[i][4]+contra_new[i][5]*N_VARIABLE, 
                contra_new[i][6]+contra_new[i][7]*N_VARIABLE);
        }
        else {
            fprintf(fp2, "%d, %d, %d, %d", contra_new[i][0]+contra_new[i][1]*N_VARIABLE, 
                contra_new[i][2]+contra_new[i][3]*N_VARIABLE, 
                contra_new[i][4]+contra_new[i][5]*N_VARIABLE, 
                contra_new[i][6]+contra_new[i][7]*N_VARIABLE);
        }*/
